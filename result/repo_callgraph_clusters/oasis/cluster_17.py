...
def test_transfer_to_openai_function():
    action_funcs: List[FunctionTool] = [FunctionTool(func) for func in [SocialAction.sign_up, SocialAction.refresh, SocialAction.create_post, SocialAction.like_post, SocialAction.unlike_post, SocialAction.dislike_post, SocialAction.undo_dislike_post, SocialAction.search_posts, SocialAction.search_user, SocialAction.follow, SocialAction.unfollow, SocialAction.mute, SocialAction.unmute, SocialAction.trend, SocialAction.repost, SocialAction.create_comment, SocialAction.like_comment, SocialAction.unlike_comment, SocialAction.dislike_comment, SocialAction.undo_dislike_comment, SocialAction.do_nothing, SocialAction.purchase_product, SocialAction.report_post, SocialAction.join_group, SocialAction.leave_group, SocialAction.listen_from_group, SocialAction.send_to_group, SocialAction.create_group]]
...
class SocialAction:
    ...
    async def refresh(self):
        """Refresh to get recommended posts.
    ...
    async def quote_post(self, post_id: int, quote_content: str):
        """Quote a specified post with a given quote content.
    ...
    async def like_post(self, post_id: int):
        """Create a new like for a specified post.
    ...
    async def dislike_post(self, post_id: int):
        """Create a new dislike for a specified post.
    ...
    async def search_posts(self, query: str):
        """Search posts based on a given query.
    ...
    async def search_user(self, query: str):
        """Search users based on a given query.
    ...
    async def trend(self):
        """Fetch the trending posts within a predefined time period.
    ...
    async def create_comment(self, post_id: int, content: str):
        """Create a new comment for a specified post given content.
    ...
    async def like_comment(self, comment_id: int):
        """Create a new like for a specified comment.
    ...
    async def dislike_comment(self, comment_id: int):
        """Create a new dislike for a specified comment.
    ...
    async def undo_dislike_comment(self, comment_id: int):
        ...
        """
        return await self.perform_action(comment_id, ActionType.UNDO_DISLIKE_COMMENT.value)
    ...
    async def purchase_product(self, product_name: str, purchase_num: int):
        ...
        return await self.perform_action(purchase_message, ActionType.PURCHASE_PRODUCT.value)
    ...
    async def report_post(self, post_id: int, report_reason: str):
        """Report a specified post with a given reason.
