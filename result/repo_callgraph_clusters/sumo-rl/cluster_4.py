...
def grid4x4(parallel=True, **kwargs):
    ...
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/grid4x4/grid4x4.net.xml', 'route_file': PATH + '/nets/RESCO/grid4x4/grid4x4_1.rou.xml', 'num_seconds': 3600})
    if parallel:
...
def arterial4x4(parallel=True, **kwargs):
    ...
    Agents have the same observation and action space
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/arterial4x4/arterial4x4.net.xml', 'route_file': PATH + '/nets/RESCO/arterial4x4/arterial4x4_1.rou.xml', 'num_seconds': 3600})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def cologne1(parallel=True, **kwargs):
    ...
    Number of actions: 4
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/cologne1/cologne1.net.xml', 'route_file': PATH + '/nets/RESCO/cologne1/cologne1.rou.xml', 'begin_time': 25200, 'num_seconds': 28800 - 25200})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def cologne3(parallel=True, **kwargs):
    ...
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/cologne3/cologne3.net.xml', 'route_file': PATH + '/nets/RESCO/cologne3/cologne3.rou.xml', 'begin_time': 25200, 'num_seconds': 28800 - 25200})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def cologne8(parallel=True, **kwargs):
    ...
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/cologne8/cologne8.net.xml', 'route_file': PATH + '/nets/RESCO/cologne8/cologne8.rou.xml', 'begin_time': 25200, 'num_seconds': 28800 - 25200})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def ingolstadt1(parallel=True, **kwargs):
    ...
    Number of actions: 3
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/ingolstadt1/ingolstadt1.net.xml', 'route_file': PATH + '/nets/RESCO/ingolstadt1/ingolstadt1.rou.xml', 'begin_time': 57600, 'num_seconds': 61200 - 57600})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def ingolstadt7(parallel=True, **kwargs):
    ...
    Number of actions: variable
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/ingolstadt7/ingolstadt7.net.xml', 'route_file': PATH + '/nets/RESCO/ingolstadt7/ingolstadt7.rou.xml', 'begin_time': 57600, 'num_seconds': 61200 - 57600})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
...
def ingolstadt21(parallel=True, **kwargs):
    ...
    Number of actions: variable
    """
    kwargs.update({'net_file': PATH + '/nets/RESCO/ingolstadt21/ingolstadt21.net.xml', 'route_file': PATH + '/nets/RESCO/ingolstadt21/ingolstadt21.rou.xml', 'begin_time': 57600, 'num_seconds': 61200 - 57600})
    if parallel:
        return parallel_env(**kwargs)
    else:
        return env(**kwargs)
