...
def labelread(file_path):
    ...
    keys = ['type', 'truncated', 'occluded', 'alpha', bbox, dimensions, location, 'rotation_y', 'score']
    labels = list()
    for line in open(file_path, 'r'):
        vals = line.split()
...
def labelread_sequence(file_path):
    ...
    dimensions = ('dimensions', ['height', 'width', 'length'])
    location = ('location', ['x', 'y', 'z'])
    keys = ['frame', 'track_id', 'type', 'truncated', 'occluded', 'alpha', bbox, dimensions, location, 'rotation_y', 'score']
    labels = list()
    for line in open(file_path, 'r'):
        vals = line.split()
        l, _ = vals_to_dict(vals, keys)
