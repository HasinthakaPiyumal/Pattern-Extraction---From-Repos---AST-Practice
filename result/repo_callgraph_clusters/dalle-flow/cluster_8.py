    ...
    def generate(self, docs: DocumentArray, parameters: Dict, **kwargs):
        ...
        for d in docs:
            ...
            for img in generated_imgs:
                ...
                _d = Document(blob=buffered.getvalue(), mime_type='image/png', tags={'text': d.text, 'generator': 'DALLE-mega', 'request_time': request_time, 'created_time': time.time()}).convert_blob_to_datauri()
                _d.text = d.text
                d.matches.append(_d)
