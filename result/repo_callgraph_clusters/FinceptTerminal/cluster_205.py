...
class SECEndpointChecker:
    ...
    async def run_all_checks(self):
        ...
        print('=' * 80)
        checks = [self.check_cik_mapping(), self.check_symbol_mapping(), self.check_company_filings(), self.check_compare_facts(), self.check_equity_ftd(), self.check_equity_search(), self.check_etf_holdings(), self.check_form_13f_hr(), self.check_htm_file(), self.check_insider_trading(), self.check_institutions_search(), self.check_latest_reports(), self.check_md_analysis(), self.check_rss_litigation(), self.check_schema_files(), self.check_sec_filing(), self.check_sic_search()]
