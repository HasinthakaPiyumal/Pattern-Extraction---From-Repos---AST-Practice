...
class Styleformer:
    ...
    def __init__(self, style=0, ctf_model_tag='prithivida/informal_to_formal_styletransfer', ftc_model_tag='prithivida/formal_to_informal_styletransfer', atp_model_tag='prithivida/active_to_passive_styletransfer', pta_model_tag='prithivida/passive_to_active_styletransfer', adequacy_model_tag='prithivida/parrot_adequacy_model'):
    ...
    def _formal_to_casual(self, input_sentence, device, quality_filter, max_candidates):
        ...
        preds = self.ftc_model.generate(input_ids, do_sample=True, max_length=32, top_k=50, top_p=0.95, early_stopping=True, num_return_sequences=max_candidates)
        gen_sentences = set()
        for pred in preds:
    ...
    def _casual_to_formal(self, input_sentence, device, quality_filter, max_candidates):
        ...
        input_ids = input_ids.to(device)
        preds = self.ctf_model.generate(input_ids, do_sample=True, max_length=32, top_k=50, top_p=0.95, early_stopping=True, num_return_sequences=max_candidates)
        gen_sentences = set()
        for pred in preds:
    ...
    def _active_to_passive(self, input_sentence, device):
        ...
        input_ids = input_ids.to(device)
        preds = self.atp_model.generate(input_ids, do_sample=True, max_length=32, top_k=50, top_p=0.95, early_stopping=True, num_return_sequences=1)
    ...
    def _passive_to_active(self, input_sentence, device):
        ...
        input_ids = input_ids.to(device)
        preds = self.pta_model.generate(input_ids, do_sample=True, max_length=32, top_k=50, top_p=0.95, early_stopping=True, num_return_sequences=1)
