...
// Node: dataSource
// Node: EmbeddedDatabaseBuilder
// Node: generateUniqueName
// Node: setType
// Node: setScriptEncoding
// Node: ignoreFailedDrops
// Node: addScript
// Node: addScripts
// Node: build
// Node: transactionManager
// Node: DataSourceTransactionManager
// Node: sqlSessionFactory
// Node: SqlSessionFactoryBean
// Node: setDataSource
// Node: setTypeAliasesPackage
// Node: jdbcTemplate
// Node: JdbcTemplate
