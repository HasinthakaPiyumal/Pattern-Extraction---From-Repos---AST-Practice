...
def compute_clusters(repo_path):
    """
    ...
    return clusters, all_functions, all_classes, output_dir


def save_clusters(clusters, all_functions, all_classes, output_dir):
    """
...
def cluster_and_save_code(repo_path):
    ...
    clusters, all_functions, all_classes, output_dir = compute_clusters(repo_path)
    save_clusters(clusters, all_functions, all_classes, output_dir)
